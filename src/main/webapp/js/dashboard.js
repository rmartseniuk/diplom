    ...
    for (var key in column) {
        switch (column[key].currency) {
            ...
            case "EUR":
                ...
                break;
            case "UAH":
                column[key].converted = (column[key].amount * global.uah).toFixed(3);
                break;
        }
        ...
        switch (user.checkedCurr) {
            ...
            case "EUR":
                ...
                break;
            case "UAH":
                column[key].converted = (column[key].converted / global.uah).toFixed(3);
                break;
        }
        if (column == incomes) {
...
function initStatisticPage() {
    ...
    changeCurrency = function () {
        switch (user.checkedCurr) {
            case "USD":
                ...
                else if (user.lastCurr == "UAH") { savings.freeMoney = (savings.freeMoney * global.uah).toFixed(3); }
                break;
            case "UAH":
                if (user.lastCurr == "UAH") { break; }
                else if (user.lastCurr == "USD") { savings.freeMoney = (savings.freeMoney / global.uah).toFixed(3); }
                else if (user.lastCurr == "EUR") { savings.freeMoney = (savings.freeMoney / global.uah).toFixed(3); }
                break;
            case "EUR":
                if (user.lastCurr == "EUR") { break; }
                else if (user.lastCurr == "USD") { savings.freeMoney = (savings.freeMoney * global.eur).toFixed(3); }
                else if (user.lastCurr == "UAH") { savings.freeMoney = (savings.freeMoney * global.eur).toFixed(3); }
                break;
        }
    ...
    switch (user.checkedCurr) {
        case "UAH":
            $(".curr").html(" Uah ").data("curr", " \u20B4");
            $(".savings-circle-currency").html(" Grivnes ");
